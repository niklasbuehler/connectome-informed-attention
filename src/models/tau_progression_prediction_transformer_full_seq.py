...
class TransformerModelFullSequence(pl.LightningModule):
    """
    ...
    def forward(self, src: Tensor, src_mask: Tensor, padding_masks: Tensor) -> Tensor:
        """
        Args:
    ...
    def step(self, batch: Any):
        ...
        logits = self.forward(x, src_mask, masks)
