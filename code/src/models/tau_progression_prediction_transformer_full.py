...
if __name__ == '__main__':
    from src.datamodules.tau_progression_datamodule_transformer import TauProgressionDataModuleTransformer
    from src.models.tau_progression_prediction_transformer_full import TransformerModelFull
    ds = TauProgressionDataModuleTransformer(data_dir="/Users/saiderbel/Desktop/ADLM/repo/connectome-based-tau-spread-prediction/data", max_len=10, batch_size=1)
    ds.setup(stage="test")
    ...
    for i, batch in enumerate(test_loader):
        if i == 246:
            batch_to_use = batch
            break
    model = TransformerModelFull.load_from_checkpoint("../../epoch_035.ckpt",
                                  d_in= 203,
                                 max_len = 10,
                                 d_model = 128,
                                 d_hid = 100,
                                 ...
                                 n_encoder_layers= 2,
                                 lr= 0.0001,
                                 connectivity_path = "/Users/saiderbel/Desktop/ADLM/repo/connectome-based-tau-spread-prediction/data/connectivity.csv"
    )

    print(model.infer(batch_to_use))